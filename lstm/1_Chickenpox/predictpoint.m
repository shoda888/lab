...
%     I = imread("0520exData/training/depth/" + timeindexOrigin(i) + ".png");
    grabMat = zeros(32, 3);
    I = readimage(poseimg,size(poseimg.Files, 1)-size(YPred, 2)+i);
    J = undistortImage(I,v3Params);
    for cnt=0:31
...
%     imshow(J);
    imwrite(J,'0520exData/training/predictpos2/' + timeindexOrigin(size(poseimg.Files, 1)-size(YPred, 2)+i) + '.png')
